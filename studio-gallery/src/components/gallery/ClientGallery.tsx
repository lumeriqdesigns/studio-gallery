...
import { Download, X, ChevronLeft, ChevronRight, ShoppingCart, Heart } from 'lucide-react'
...
export function ClientGallery({
  ...
  const downloadPhoto = (photo: Photo) => {
    ...
    a.href = photoUrl(photo.storage_path)
        ...
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="relative inline-flex items-center gap-1.5 rounded-lg bg-neutral-900 text-white px-3 py-1.5 text-xs font-medium hover:bg-neutral-800"
            >
        ...
        <div className="fixed inset-0 z-50 bg-black/95 flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center relative px-2">
            <button
              ...
              className="absolute left-2 p-2 text-white/60 hover:text-white disabled:opacity-20"
              disabled={lightbox === 0}
            >
            ...
            <button
              ...
              className="absolute right-2 p-2 text-white/60 hover:text-white disabled:opacity-20"
